import type { IUser, IUserContextAuthorization } from "@loomcore/common/models";
import type { IDatabase } from "../../databases/models/index.js";
import { PostgresDatabase } from "../../databases/postgres/postgres.database.js";

export async function getUserContextAuthorizations(
	database: IDatabase,
	user: IUser,
	...
	).getUserAuthorizations(user._id, orgId);
